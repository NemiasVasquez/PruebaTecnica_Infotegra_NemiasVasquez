...
const ModalDetalles = ({ cerrarModal, nombreModal, datos, exportable = true }) => {
    if (!datos || datos.length === 0) return null;

    return (
        <ModalBase cerrarModal={cerrarModal} nombreModal={nombreModal} datos={datos} exportable={exportable}
            children={
